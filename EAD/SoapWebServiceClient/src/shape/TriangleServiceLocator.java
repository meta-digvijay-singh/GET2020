...
public class TriangleServiceLocator extends org.apache.axis.client.Service implements shape.TriangleService {
    ...
    private java.lang.String Triangle_address = "http://localhost:8080/SoapWebService/services/Triangle";
    ...
    public shape.Triangle getTriangle() throws javax.xml.rpc.ServiceException {
    ...
    public shape.Triangle getTriangle(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            shape.TriangleSoapBindingStub _stub = new shape.TriangleSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (shape.Triangle.class.isAssignableFrom(serviceEndpointInterface)) {
                shape.TriangleSoapBindingStub _stub = new shape.TriangleSoapBindingStub(new java.net.URL(Triangle_address), this);
                _stub.setPortName(getTriangleWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("http://shape", "TriangleService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("http://shape", "Triangle"));
        }
